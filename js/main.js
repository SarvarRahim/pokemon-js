var pokemons = [
  ...
  var elPokemons = document.querySelector('.pokemon');
  var elPokemonItemTemplete = document.querySelector('#pokemon-item-templete').content;
  var elPokemonFragment = document.createDocumentFragment();

  for(var data in pokemons){
    var elPokemonItem = elPokemonItemTemplete.cloneNode(true);

    elPokemonItem.querySelector('.pokemon__img').src = pokemons[data].img;
    elPokemonItem.querySelector('.pokemon__name').textContent = pokemons[data].name;
    elPokemonItem.querySelector('.pokemon__number').textContent = pokemons[data].num;

    elPokemonFragment.appendChild(elPokemonItem);
  }

  elPokemons.appendChild(elPokemonFragment);